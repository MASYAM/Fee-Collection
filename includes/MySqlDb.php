...
//    {
//           $sql = " INSERT INTO extra_added_items (item) SELECT DISTINCT receipt_item from transaction_receipt_item WHERE NOT (receipt_item = 'Tuition fees' OR receipt_item = 'Fines' OR receipt_item = 'Other Charges' OR receipt_item = 'Admission fees' OR receipt_item = 'Annual Charges' OR receipt_item = 'Computer fees' OR receipt_item = 'Literacy School Charges' OR receipt_item = 'Labratory fees' OR receipt_item = 'Khatas/ Test Papers' OR receipt_item = 'Certificate' OR receipt_item = 'Board/ Center fees' OR receipt_item = 'Building fund' OR receipt_item = 'extra item' ) ";
//           $query_run = $this->query($sql);
//
//           return $this->affected_rows() ? 'created successfully' : 'not been created';
//    }
