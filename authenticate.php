	...
	<body>
					...
					<div  style="width:500px;height:250px;border:3px solid #ff3300;border-radius:10px;margin:200px auto 0 auto;">
						...
						<form action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" method="POST">
                        	...
                        	<span style="color:#000;font-size:15px;font-weight:bold;">
								Username:&nbsp;&nbsp;&nbsp;
							</span>	
								<input type="text" style="border:2px solid  blue;width:200px;height:20px;border-radius:10px;" class="<?php if ($validationresults==FALSE) echo "invalid"; else echo "input_box"; ?>" id="user" name="user" >
							</br>
							<span  style="color:#000;font-size:15px;font-weight:bold;">
								<b>Password:&nbsp;&nbsp;&nbsp;</b>
							</span>	
							<input name="pass" style="border:2px solid  blue;width:200px;height:20px;border-radius:10px;" type="password" class="<?php if ($validationresults==FALSE) echo "invalid"; else echo "input_box"; ?>" id="pass" >
							</br>
                                                        ...
                                                        <?php
                                                          ...
                                                          <tr>
                                                           <td>
                                                          <span style="color:blue;"><b>Type the captcha below:</b></span>-->
                                                          <?php
                                                          //require_once('recaptchalib.php');
							...
							<button type="submit" id="login_submit_button"  name="Submit" style="position:relative;left:105px;font-weight:bold;">
								Login
                             </button>
<!--							<ul id="forgottenpassword">
								<li class="boldtext">|</li>
								<li><a href="http://www.freelancesuite.com/demo/forgot.php">Forgotten it?</a></li>
							</ul>-->
    ...
    <span  style="width:300px;height:100px;margin:auto;">
	   <a href="#" style="text-decoration:none;color:#ccc;">Copyright &copy; 2017,</a><a href="#" style="text-decoration:none;color:#ccc;">&nbsp;PIXITALE</a>
    </span>
